...
``KronGen`` - The bare basics for your new model
===============================================================================
...
Below are the default configuration parameters for the ``KronGen`` model.

.. literalinclude:: ../../src/models/KronGen/KronGen_cfg.yml
   :language: yaml
   :start-after: ---
